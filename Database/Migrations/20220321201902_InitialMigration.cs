    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyStatuses", x => x.StatusCode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DOC = table.Column<DateTime>(type: "date", nullable: false),
                    Photos = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    About = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RequesterId = table.Column<int>(type: "int", nullable: false),
                    AddresseeId = table.Column<int>(type: "int", nullable: false),
                    SpecifiedDateTime = table.Column<DateTime>(type: "date", nullable: false),
                    StatusCode = table.Column<string>(type: "nvarchar(1)", nullable: false),
                    SpecifierId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendshipStatuses", x => new { x.RequesterId, x.AddresseeId, x.SpecifiedDateTime });
                    table.ForeignKey(
                        name: "FK_FriendshipStatuses_AspNetUsers_SpecifierId",
                        column: x => x.SpecifierId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FriendshipStatuses_Friendships_RequesterId_AddresseeId",
                        columns: x => new { x.RequesterId, x.AddresseeId },
                        principalTable: "Friendships",
                        principalColumns: new[] { "RequesterId", "AddresseeId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FriendshipStatuses_MyStatuses_StatusCode",
                        column: x => x.StatusCode,
                        principalTable: "MyStatuses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FriendshipStatuses_SpecifierId",
                table: "FriendshipStatuses",
                column: "SpecifierId");

            migrationBuilder.CreateIndex(
                name: "IX_FriendshipStatuses_StatusCode",
                table: "FriendshipStatuses",
                column: "StatusCode");
